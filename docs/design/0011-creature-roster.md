...
eight creatures, producing **192 candidates across levels 1–120**.
...
This proposal does not yet replace the current derived Overall Level. If
Adventure Level is accepted, the relationship between Adventure Level, Overall
Level, Talent Points, and Combat Class progression needs a separate decision.
